...
const EVENTS = [
  {
    ...
    description: "Deskripsi singkat tentang acaranya tuh kayak gimana gitu. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
    status: "upcoming",
    card_image_url: "https://images.unsplash.com/photo-1543326727-cf6c39e8f84c?w=1200",
  ...
  },
  {
    ...
    description: "Kejuaraan karate terbuka antar universitas se-Indonesia. Diselenggarakan bersama FORKI dalam rangka memperingati hari olahraga nasional.",
    status: "active",
    card_image_url: "https://images.unsplash.com/photo-1555597673-b21d5c935865?w=1200",
  ...
  },
  {
    ...
    description: "Turnamen golf amal terbuka untuk sivitas akademika IPB. Hasil disumbangkan untuk beasiswa mahasiswa.",
    status: "upcoming",
    card_image_url: "https://images.unsplash.com/photo-1535131749006-b7f58c99034b?w=1200",
  ...
  },
  {
    ...
    description: "Hackathon 48 jam bertemakan inovasi teknologi untuk pertanian dan lingkungan. Terbuka untuk mahasiswa seluruh Indonesia.",
    status: "active",
    card_image_url: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1200",
  ...
  },
  {
    ...
    description: "Gelaran Mahasiswa Teknologi dan Informasi tingkat nasional. IPB University menjadi tuan rumah.",
    status: "upcoming",
    card_image_url: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=1200",
  ...
  },
  {
    ...
    status: "upcoming",
    card_image_url: "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=1200",
  ...
  },
  {
    ...
    description: "Kejuaraan renang tahunan antar fakultas se-IPB University. Kategori gaya bebas, gaya punggung, dan gaya kupu-kupu.",
    status: "upcoming",
    card_image_url: "https://images.unsplash.com/photo-1560090995-01632a28895b?w=1200",
  ...
  },
  {
    ...
    description: "Turnamen esports terbesar di IPB University. Kategori Mobile Legends, VALORANT, dan FIFA.",
    status: "active",
    card_image_url: "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200",
...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const pct = Math.min(((Date.now() - startRef.current) / INTERVAL_MS) * 100, 100);
      setProgress(pct);
      if (pct < 100) {
...
{/* ── Gradients ─────────────────────────────────────────────────────── */}
<div className="absolute inset-0 z-[1]" style={{ background: "linear-gradient(to right, #000 0%, rgba(0,0,0,0.5) 50%, transparent 75%)" }} />
<div className="absolute inset-0 z-[2]" style={{ background: "linear-gradient(to top, #000 10%, transparent 50%)" }} />
...
<div className="absolute inset-0 z-[3] pointer-events-none">
  ...
  {/* horizontal — left to right, only covers left 50% */}
  ...
  <div style={{ position: "absolute", inset: 0, backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", maskImage: "linear-gradient(to right, black 0%, transparent 12%)"  }} />
      ...
      <div className="absolute top-0 left-0 right-0 h-1 bg-white/10 z-30">
        <div className="h-full bg-yellow-400" style={{ width: `${progress}%`, transition: "width 0.1s linear" }} />
      </div>

      {/* ── Text — anchored top left ───────────────────────────────────────── */}
      <div className="absolute z-10 left-[160px] max-w-lg" style={{ top: "80px" }}>
        <p className="text-yellow-400 text-xs font-bold uppercase mb-3" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: "0.2em" }}>
          {activeEvent.status === "active" ? "⬤ Ongoing" : "Coming Soon"}
        </p>
        <h1
          key={activeEvent.id + "-t"}
          className="text-white uppercase leading-none mb-3"
          style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(2.8rem, 5vw, 5rem)", animation: "fade-up 0.4s ease forwards" }}
        >
          {activeEvent.name}
        </h1>
        <p
          ...
          style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", animation: "fade-up 0.4s ease 0.07s both",
            display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}
        >
          {activeEvent.description}
        </p>
        <Button href={`/events/${activeEvent.slug}`} variant="primary" size="md">More Details</Button>
      </div>

      {/* ── Cards — fixed height, no vertical scaling ─────────────────────── */}
      <div className="absolute z-10 bottom-20 left-0 right-0 px-[160px] pb-10">
        <p className="text-white text-sm font-bold uppercase mb-5" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: "0.15em" }}>
          Featured Events
        </p>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  overflow:     "hidden",
                  outline:      isActive ? "2px solid rgba(234,179,8,0.9)" : "2px solid transparent",
